...
const Navbar = () => {
  ...
  return (
    ...
    <Link to={token['mytoken'] ? 'home':'/'} onClick={close}><img className='absolute max-sm:-top-6 cursor-pointer max-sm:w-28 -top-10' src='http://localhost:5173/atoz.png' width='150' /></Link>
