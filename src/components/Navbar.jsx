...
const Navbar = () => {
    ...
    window.addEventListener('scroll',(e)=>{
      if(window.scrollY>80 && e.target.location.hash==='#/home'){
        sethidemenu(false)
      }else{
        sethidemenu(true)
      }
  ...
  return (
    ...
    <Link to={token['mytoken'] ? 'home':'/'} onClick={close}><img className='absolute max-sm:-top-6 cursor-pointer max-sm:w-28 -top-10' src='https://subramanyam12.github.io/ecommerce/atoz.png' width='150' /></Link>
